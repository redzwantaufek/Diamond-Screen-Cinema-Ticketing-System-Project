	...
	public WelcomePage(String name) 
	{
		...
		btnNext.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{
				...
				//to get the price for each type of cinema
				...
				//if else to show the error message
                ...
                {
                	// to connect with Fill Information frame
        ...
        Thread clock  = new Thread()
        {
            public void run()
            {
                for(;;)
                {
                    ...
                    dateTime.setText(day+"/"+(((month+1)<10)?"0"+(month+1):(month+1))+"/"+year+"  "+ hour+":"+minute+":"+second);
                        try 
                        {
